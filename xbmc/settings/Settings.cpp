...
const std::string CSettings::SETTING_VIDEOPLAYER_USEMEDIACODECMPEG2 = "videoplayer.usemediacodecmpeg2";
const std::string CSettings::SETTING_VIDEOPLAYER_USEMEDIACODECMPEG4 = "videoplayer.usemediacodecmpeg4";
const std::string CSettings::SETTING_VIDEOPLAYER_USEMEDIACODECH264 = "videoplayer.usemediacodech264";
